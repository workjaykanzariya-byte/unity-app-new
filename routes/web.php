...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::middleware('admin.role:global_admin,industry_director,ded,circle_leader')->group(function () {
            Route::get('/', function () {
        ...
        Route::middleware('admin.role:global_admin,industry_director,ded')->group(function () {
        ...
        Route::middleware('admin.role:global_admin,industry_director,circle_leader')->group(function () {
